...
class TestDMExtended(DMTestCase):
    ...
    def test_tmpsf(self):
        self.preload_tmpsf()
        self.preload_ui()
        data_product_ids, _  = self.container.resource_registry.find_resources_ext(alt_id='DPROD82', alt_id_ns='PRE', id_only=True)
        rdt = self.ph.rdt_for_data_product(data_product_ids[0])
        rdt['time'] = [0]
        rdt['tmpsf_cal_coeffs'] = [[[  3.50351258e-03,  -2.51016837e-04,   2.50346350e-06,
          -7.03583241e-08],
        [  3.52734559e-03,  -2.50806607e-04,   2.52981232e-06,
          -6.96816322e-08],
        [  3.52908906e-03,  -2.51527367e-04,   2.55498318e-06,
          -7.22727455e-08],
        [  3.51065790e-03,  -2.51451726e-04,   2.51618865e-06,
          -6.37003888e-08],
        [  3.52043331e-03,  -2.51319883e-04,   2.52146925e-06,
          -7.95333725e-08],
        [  3.47203853e-03,  -2.50010391e-04,   2.46129148e-06,
          -7.12959689e-08],
        [  3.53004946e-03,  -2.51247554e-04,   2.52159304e-06,
          -7.79481131e-08],
        [  3.51399903e-03,  -2.51445571e-04,   2.50096227e-06,
          -7.60943129e-08],
        [  3.51653262e-03,  -2.51051220e-04,   2.53455191e-06,
          -8.13292184e-08],
        [  3.49296329e-03,  -2.50559803e-04,   2.47183988e-06,
          -8.12905756e-08],
        [  3.53707354e-03,  -2.51970816e-04,   2.57716627e-06,
          -7.51392864e-08],
        [  3.50165750e-03,  -2.50961390e-04,   2.54649893e-06,
          -7.46908409e-08],
        [  3.48026128e-03,  -2.50548194e-04,   2.51923385e-06,
          -5.67882020e-08],
        [  3.52136264e-03,  -2.51368617e-04,   2.54399945e-06,
          -7.08951737e-08],
        [  3.46059399e-03,  -2.50438586e-04,   2.44750060e-06,
          -6.58220821e-08],
        [  3.48305997e-03,  -2.50508133e-04,   2.50598191e-06,
          -5.80161432e-08],
        [  3.49025190e-03,  -2.50309162e-04,   2.50557916e-06,
          -7.25120916e-08],
        [  3.53877751e-03,  -2.51807380e-04,   2.55602860e-06,
          -6.52512641e-08],
        [  3.52973394e-03,  -2.52011192e-04,   2.54873468e-06,
          -6.14820328e-08],
        [  3.52310008e-03,  -2.51300883e-04,   2.52824483e-06,
          -6.74465833e-08],
        [  3.50603633e-03,  -2.50897867e-04,   2.54479746e-06,
          -7.41559532e-08],
        [  3.51995561e-03,  -2.51784158e-04,   2.56187105e-06,
          -6.56020154e-08],
        [  3.48834955e-03,  -2.49291102e-04,   2.76692657e-06,
          -6.84152614e-08],
        [  3.49851973e-03,  -2.51264850e-04,   2.47592261e-06,
          -6.64877670e-08]]]
        breakpoint(locals(), globals())
        rdt['tmpsf_cal_coeffs']
